...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; #IO_L5P_T0_34 Sch=ar[0]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { uart_tx }]; #IO_L2N_T0_34 Sch=ar[1]
...
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { clk_rst }]; #IO_L10P_T1_34 Sch=ar[4]
...
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { disp_ctrl[2] }]; #IO_L1N_T0_AD0N_35 Sch=rpio_12_r
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { spi_tx }]; #IO_L15N_T2_DQS_13 Sch=rpio_13_r
...
set_property -dict { PACKAGE_PIN B19   IOSTANDARD LVCMOS33 } [get_ports { spi_sck }]; #IO_L2P_T0_AD8P_35 Sch=rpio_16_r
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { rpio_17_r }]; #IO_L11P_T1_SRCC_13 Sch=rpio_17_r
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { disp_ctrl[1] }]; #IO_L1P_T0_AD0P_35 Sch=rpio_18_r
#set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { rpio_19_r }]; #IO_L14N_T2_SRCC_13 Sch=rpio_19_r
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 } [get_ports { disp_ctrl[3] }]; #IO_L2N_T0_AD8N_35 Sch=rpio_20_r
...
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { disp_ctrl[0] }]; #IO_L15N_T2_DQS_AD12N_35 Sch=rpio_25_r
