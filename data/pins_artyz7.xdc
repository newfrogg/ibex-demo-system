...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { uart_rx  }]; #IO_L5P_T0_34            Sch=CK_IO0
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { uart_tx  }]; #IO_L2N_T0_34            Sch=CK_IO1
...
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { clk_rst  }]; #IO_L10P_T1_34           Sch=CK_IO4
...
## Misc. ChipKit Ports
# set_property -dict { PACKAGE_PIN Y13   IOSTANDARD LVCMOS33 } [get_ports { clk_rst }]; #IO_L20N_T3_13 Sch=CK_IOA
